...
if(VITA)
	# Keep the initial Vita audio path small: the game needs libopenmpt for .j2b music,
	# while Vorbis is not used by the original assets and adds an untested dependency.
	set(_NCINE_WITH_AUDIO_DEFAULT ON)
	set(_NCINE_WITH_VORBIS_DEFAULT OFF)
	set(_NCINE_WITH_OPENMPT_DEFAULT ON)
else()
	set(_NCINE_WITH_AUDIO_DEFAULT ON)
	set(_NCINE_WITH_VORBIS_DEFAULT ON)
	set(_NCINE_WITH_OPENMPT_DEFAULT ON)
endif()
option(NCINE_WITH_AUDIO "Enable OpenAL support and thus sound" ${_NCINE_WITH_AUDIO_DEFAULT})
cmake_dependent_option(NCINE_WITH_VORBIS "Enable Ogg Vorbis audio file support" ${_NCINE_WITH_VORBIS_DEFAULT} "NCINE_WITH_AUDIO" OFF)
cmake_dependent_option(NCINE_WITH_OPENMPT "Enable module (libopenmpt) audio file support" ${_NCINE_WITH_OPENMPT_DEFAULT} "NCINE_WITH_AUDIO" OFF)
