...
elseif(WINDOWS_PHONE OR WINDOWS_STORE)
	...
	elseif(VITA)
		...
		# Keep a gap after the executable segment for SELF metadata generated by vita-elf-create.
		# The default leaves headroom for the audio-enabled binary while remaining below Vita's user RAM limit.
		set(VITA_INIT_ARRAY_ADDRESS "0x81840000" CACHE STRING "Fixed address for the Vita .init_array section")
		if(VITA_INIT_ARRAY_ADDRESS)
			target_link_options(${NCINE_APP} PRIVATE "-Wl,--section-start,.init_array=${VITA_INIT_ARRAY_ADDRESS}")
		endif()
		...
		if(NOT IS_DIRECTORY "${NCINE_CONTENT_DIR}")
			message(FATAL_ERROR "PS Vita VPK requires a valid NCINE_CONTENT_DIR")
		endif()
		file(GLOB_RECURSE VITA_CONTENT_FILES LIST_DIRECTORIES FALSE CONFIGURE_DEPENDS "${NCINE_CONTENT_DIR}/*")
		if(NOT VITA_CONTENT_FILES)
			message(FATAL_ERROR "PS Vita VPK content directory is empty")
		endif()
		...
		vita_create_vpk(${NCINE_APP}.vpk ${VITA_TITLEID} ${NCINE_APP}.self
			...
			# VitaShell rejects the shared RGBA icon; Vita requires an opaque indexed PNG.
