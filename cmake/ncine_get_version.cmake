if(NCINE_VERSION_FROM_GIT)
	...
	if(GIT_EXECUTABLE AND IS_DIRECTORY ${CMAKE_SOURCE_DIR}/.git)
		execute_process(
			...
			#ERROR_QUIET
			ERROR_VARIABLE GIT_REV_COUNT_ERROR
		...
		execute_process(
			...
			#ERROR_QUIET
			ERROR_VARIABLE GIT_LAST_COMMIT_DATE_ERROR
			OUTPUT_STRIP_TRAILING_WHITESPACE
		)
		...
		if(GIT_FAIL)
			...
			if(GIT_REV_COUNT_ERROR)
				message(STATUS "- GIT_REV_COUNT: ${GIT_REV_COUNT_ERROR}")
			endif()
			if(GIT_SHORT_HASH_ERROR)
				message(STATUS "- GIT_SHORT_HASH: ${GIT_SHORT_HASH_ERROR}")
			endif()
			if(GIT_LAST_COMMIT_DATE_ERROR)
				message(STATUS "- GIT_LAST_COMMIT_DATE: ${GIT_LAST_COMMIT_DATE_ERROR}")
			endif()
