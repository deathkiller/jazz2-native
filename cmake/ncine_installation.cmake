if(MSVC OR APPLE OR EMSCRIPTEN)
	...
	set(README_INSTALL_DESTINATION share/doc/${NCINE_APP_NAME})
	set(DATA_INSTALL_DESTINATION share/${NCINE_APP_NAME}/Content)
...
if (${_versionComponentsLength} GREATER 1)
	list(GET _versionComponents 1 CPACK_PACKAGE_VERSION_MINOR)
else()
	set(CPACK_PACKAGE_VERSION_MINOR "0")
endif()
if (${_versionComponentsLength} GREATER 2)
	list(GET _versionComponents 2 CPACK_PACKAGE_VERSION_PATCH)
else()
...
if(NOT EMSCRIPTEN)
	install(DIRECTORY ${NCPROJECT_DATA_DIR}/Content/ DESTINATION ${DATA_INSTALL_DESTINATION})
else()
...
elseif(APPLE)
	...
	if(EXISTS ${NCINE_CONFIG_H})
		...
		if(IS_DIRECTORY ${FRAMEWORKS_DIR}/zlib.framework)
