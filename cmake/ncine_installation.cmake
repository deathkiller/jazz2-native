...
elseif(APPLE)
	...
	set(CPACK_BUNDLE_NAME ${NCINE_APP})
...
if(DEFINED NCINE_SYSTEM_NAME)
	if(DEFINED NCINE_COMPILER)
		set(CPACK_PACKAGE_FILE_NAME "${NCINE_APP_NAME}-v${CPACK_PACKAGE_VERSION}-${NCINE_SYSTEM_NAME}-${NCINE_COMPILER}")
	else()
		set(CPACK_PACKAGE_FILE_NAME "${NCINE_APP_NAME}-v${CPACK_PACKAGE_VERSION}-${NCINE_SYSTEM_NAME}")
	endif()
else()
	set(CPACK_PACKAGE_FILE_NAME "${NCINE_APP_NAME}-v${CPACK_PACKAGE_VERSION}")
endif()
