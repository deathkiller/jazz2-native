		...
		if(NCINE_ASSEMBLE_DEB)
			...
			if(DPKG)
				...
				if(GLFW_FOUND AND NCINE_PREFERRED_BACKEND STREQUAL "GLFW")
					set(CPACK_DEBIAN_PACKAGE_DEPENDS "libglew2.2, libglfw3, libopenal1, libopenmpt0")
				elseif(SDL2_FOUND AND NCINE_PREFERRED_BACKEND STREQUAL "SDL2")
					set(CPACK_DEBIAN_PACKAGE_DEPENDS "libglew2.2, libsdl2-2.0-0, libopenal1, libopenmpt0")
				else()
