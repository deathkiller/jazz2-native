...
function(ncine_apply_compiler_options target)
	...
	elseif(PLATFORM_DREAMCAST)
		# KallistiOS (the KOS dreamcast.toolchain.cmake file sets PLATFORM_DREAMCAST)
	...
	if(MSVC)
		...
		if("${CMAKE_CXX_COMPILER_ID}" STREQUAL "GNU")
			...
			elseif(NINTENDO_WII OR NINTENDO_GAMECUBE OR PLATFORM_DREAMCAST)
				# Conservative optimization on the PowerPC consoles and Dreamcast: fast-math reordering is untested on
				# Gekko/Broadway paired singles and code size matters (24 MB GameCube, 16 MB Dreamcast)
				target_compile_options(${target} PRIVATE $<$<CONFIG:Release>:-O2>)
			else()
