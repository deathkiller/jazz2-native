if(NCINE_BUILD_ANDROID)
	...
	set(ANDROID_PASSTHROUGH_ARGS -DNCINE_ROOT=${NCINE_ROOT} -DCMAKE_BUILD_TYPE=${CMAKE_BUILD_TYPE}
		-DNCINE_APP=${NCINE_APP} -DNCINE_VERSION=${NCINE_VERSION} -DDEATH_DEBUG=${DEATH_DEBUG} -DDEATH_LOGGING=${DEATH_LOGGING}
		-DNCINE_DYNAMIC_LIBRARY=${NCINE_DYNAMIC_LIBRARY} -DNCINE_DOWNLOAD_DEPENDENCIES=OFF -DNCINE_LIBS=${NCINE_LIBS}
		-DEXTERNAL_ANDROID_DIR=${EXTERNAL_ANDROID_DIR}
		-DGENERATED_INCLUDE_DIR=${GENERATED_INCLUDE_DIR} -DNCINE_STRIP_BINARIES=${NCINE_STRIP_BINARIES}
	#	-DNCINE_WITH_PNG=${NCINE_WITH_PNG}
		-DNCINE_WITH_WEBP=${NCINE_WITH_WEBP} -DNCINE_WITH_AUDIO=${NCINE_WITH_AUDIO} -DNCINE_WITH_VORBIS=${NCINE_WITH_VORBIS} -DNCINE_WITH_OPENMPT=${NCINE_WITH_OPENMPT}
		-DNCINE_WITH_THREADS=${NCINE_WITH_THREADS} -DNCINE_WITH_LUA=${NCINE_WITH_LUA} -DNCINE_WITH_ANGELSCRIPT=${NCINE_WITH_ANGELSCRIPT}
	...
	if(NCINE_INPUT_DEBUGGING)
		list(APPEND ANDROID_PASSTHROUGH_ARGS -DNCINE_INPUT_DEBUGGING=ON)
	endif()
