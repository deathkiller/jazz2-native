...
if(USE_TLS)
	...
	if(USE_MBED_TLS)
		list(APPEND _IXWEBSOCKET_HEADERS ixwebsocket/IXSocketMbedTLS.h)
		list(APPEND _IXWEBSOCKET_SOURCES ixwebsocket/IXSocketMbedTLS.cpp)
	elseif(USE_SECURE_TRANSPORT)
		list(APPEND _IXWEBSOCKET_HEADERS ixwebsocket/IXSocketAppleSSL.h)
		list(APPEND _IXWEBSOCKET_SOURCES ixwebsocket/IXSocketAppleSSL.cpp)
	elseif(USE_OPEN_SSL OR USE_LIBRE_SSL)
		list(APPEND _IXWEBSOCKET_HEADERS ixwebsocket/IXSocketOpenSSL.h)
		list(APPEND _IXWEBSOCKET_SOURCES ixwebsocket/IXSocketOpenSSL.cpp)
	else()
