...
//			IM_//ASSERT(IM_ARRAYSIZE(charNames) == IM_ARRAYSIZE(charKeys));
...
//#if defined(_WIN32)
//	ImGui::GetMainViewport()->PlatformHandleRaw = reinterpret_cast<void *>(glfwGetWin32Window(window));
//#endif
//
...
//{
//	ImGuiIO &io = ImGui::GetIO();
//	IM_//ASSERT(io.Fonts->IsBuilt() && "Font atlas not built! Missing call to ImGuiDrawing::buildFonts() function?");
//
...
//{
//	IM_//ASSERT(installedCallbacks_ == false && "Callbacks already installed!");
//	IM_//ASSERT(window_ == window);
//
...
//{
//	IM_//ASSERT(installedCallbacks_ == true && "Callbacks not installed!");
//	IM_//ASSERT(window_ == window);
//
...
//#else
//	const bool isAppFocused = glfwGetWindowAttrib(window_, GLFW_FOCUSED) != 0;
//#endif
//	if (isAppFocused)
//	{
