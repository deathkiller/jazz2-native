...
//		inline float absLineHeight() const {
//			return lineHeight_ * absScaleFactor_.y;
//		}
//		/// Sets the text node line height
//		inline void setLineHeight(float lineHeight) {
//			lineHeight_ = lineHeight;
//		}
//
//		/// Gets the constant string to render
//		inline const nctl::String& string() const {
//			return string_;
//		}
//		/// Gets the string to render
//		inline nctl::String& string() {
//			return string_;
//		}
