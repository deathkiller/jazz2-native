...
#	endif
	...
	void MainMenu::OnBeginFrame()
	{
		...
		_texturedBackgroundPos.Y += timeMult * -0.2f + timeMult * std::sinf(_texturedBackgroundPhase) * 0.6f;
	...
	void MainMenu::RenderTexturedBackground(RenderQueue& renderQueue)
	{
		...
		command->material().uniform("shift")->setFloatValue(_texturedBackgroundPos.X, _texturedBackgroundPos.Y);
		// TODO: horizonColor
