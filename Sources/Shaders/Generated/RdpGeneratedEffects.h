// Generated by ShaderCompiler (--emit-fixed-function rdp). Do not edit manually.
#pragma once
...
namespace nCine::RHI::RDP
{
	...
	*/
	...
	namespace
	{
		...
		// Colorized - from Colorized.shader:fixed_function(rdp)
		...
		void Colorized_Effect(EffectContext& ctx)
		{
			...
			int passes = clamp(int(ceil(max(0.0f, max(max(gain.x, gain.y), gain.z)))), 1, 2);
