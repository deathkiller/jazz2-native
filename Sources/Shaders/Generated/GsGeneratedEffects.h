// Generated by ShaderCompiler (--emit-fixed-function gs). Do not edit manually.
#pragma once

#if defined(WITH_RHI_GS)
...
namespace nCine::RHI::GS
{
	...
	*/
	...
	namespace
	{
		...
		// Transition - from Transition.shader:fixed_function(gx, pica, gu, gs, rdp, legacygl)
