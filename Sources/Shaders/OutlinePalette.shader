...
void fixed_function() {
	// Console fixed-function tier: identical to Outline.shader's block - the palette lookup itself is
	// texture state (palette bank / TLUT / baked variant) selected by the dispatch, not shading
