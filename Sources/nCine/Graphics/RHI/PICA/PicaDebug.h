...
{
	/**
		@brief Debug-output and object-labelling stub of the PICA backend
	...
	*/
	...
	{
	public:
		/** @brief Object types that can be labelled (values are irrelevant for the PICA backend) */
		...
		/**
			@brief RAII scope for a debug message group (a no-op for the PICA backend)
		*/
		class ScopedGroup
		{
		public:
