...
{
	/**
		@brief Debug-output and object-labelling stub of the GU backend
	...
	*/
	...
	{
	public:
		/** @brief Object types that can be labelled (values are irrelevant for the GU backend) */
		...
		/**
			@brief RAII scope for a debug message group (a no-op for the GU backend)
		*/
		class ScopedGroup
		{
		public:
