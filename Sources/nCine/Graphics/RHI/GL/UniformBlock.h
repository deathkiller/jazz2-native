...
namespace nCine::RHI
{
	...
	class UniformBlock
	{
		friend class UniformBlockCache;
	...
	public:
		...
		UniformBlock();
		UniformBlock(GLuint program, GLuint blockIndex, DiscoverUniforms discover);
		UniformBlock(GLuint program, GLuint blockIndex);
	...
	private:
		...
		StaticHashMap<String, Uniform, BlockUniformHashSize> blockUniforms_;
