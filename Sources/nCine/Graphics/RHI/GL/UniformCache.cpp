...
namespace nCine::RHI
{
	...
	UniformCache::UniformCache(const Uniform* uniform)
		: uniform_(uniform), dataPointer_(nullptr), isDirty_(false)
	{
		DEATH_ASSERT(uniform);
	}

	const GLfloat* UniformCache::GetFloatVector() const
	{
	...
	GLfloat UniformCache::GetFloatValue(std::uint32_t index) const
	{
	...
	const GLint* UniformCache::GetIntVector() const
	{
	...
	GLint UniformCache::GetIntValue(std::uint32_t index) const
	{
	...
	bool UniformCache::SetFloatVector(const GLfloat* vec)
	{
	...
	bool UniformCache::SetFloatValue(GLfloat v0)
	{
		DEATH_ASSERT(uniform_ == nullptr || dataPointer_ != nullptr);
	...
	bool UniformCache::SetFloatValue(GLfloat v0, GLfloat v1)
	{
		DEATH_ASSERT(uniform_ == nullptr || dataPointer_ != nullptr);
	...
	bool UniformCache::SetFloatValue(GLfloat v0, GLfloat v1, GLfloat v2)
	{
		DEATH_ASSERT(uniform_ == nullptr || dataPointer_ != nullptr);
	...
	bool UniformCache::SetFloatValue(GLfloat v0, GLfloat v1, GLfloat v2, GLfloat v3)
	{
		DEATH_ASSERT(uniform_ == nullptr || dataPointer_ != nullptr);
	...
	bool UniformCache::SetIntVector(const GLint* vec)
	{
		DEATH_ASSERT(uniform_ == nullptr || dataPointer_ != nullptr);
	...
	bool UniformCache::SetIntValue(GLint v0)
	{
		DEATH_ASSERT(uniform_ == nullptr || dataPointer_ != nullptr);
	...
	bool UniformCache::SetIntValue(GLint v0, GLint v1)
	{
		DEATH_ASSERT(uniform_ == nullptr || dataPointer_ != nullptr);
	...
	bool UniformCache::SetIntValue(GLint v0, GLint v1, GLint v2)
	{
		DEATH_ASSERT(uniform_ == nullptr || dataPointer_ != nullptr);
	...
	bool UniformCache::SetIntValue(GLint v0, GLint v1, GLint v2, GLint v3)
	{
		DEATH_ASSERT(uniform_ == nullptr || dataPointer_ != nullptr);
	...
	bool UniformCache::CheckFloat() const
	{
	...
	bool UniformCache::CheckInt() const
	{
	...
	bool UniformCache::CheckComponents(std::uint32_t requiredComponents) const
	{
