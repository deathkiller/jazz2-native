...
namespace nCine::RHI::GXM
{
	...
	/**
		...
		GxmUniformCache holds the value.
	*/
	class GxmUniform
	{
		friend class GxmShaderProgram;
		friend class GxmUniformBlock;
	...
	public:
		...
		GxmUniform(GxmShaderProgram* owner, const char* name, ShaderCompiler::UniformType type, std::int32_t arraySize, std::int32_t location)
		...
		inline GxmShaderProgram* GetOwner() const {
			return _owner;
		}
	...
	*/
	...
	{
		friend class GxmShaderProgram;
		friend class GxmUniformBlockCache;
	...
	public:
		...
		GxmUniformBlock(std::uint32_t index, const char* name, std::int32_t dataSize)
		...
		GxmUniform* GetUniform(const char* name) {
			for (GxmUniform& u : _members) {
	...
	private:
		...
		SmallVector<GxmUniform, 0> _members;
	...
	*/
	...
	public:
		...
		GxmAttribute(const char* name, ShaderCompiler::UniformType type, std::int32_t location)
