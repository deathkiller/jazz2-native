...
{
	/**
		@brief Shader-object stub of the GX backend
	...
	*/
	...
	{
	public:
		/** @brief Compilation status of the shader (always @ref Status::Compiled for the GX backend) */
		enum class Status
		{
			NotCompiled,
			CompilationFailed,
		...
		/** @brief When the compilation status is checked (irrelevant for the GX backend) */
