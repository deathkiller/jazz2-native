...
{
	/**
		@brief Debug-output and object-labelling stub of the PVR backend
	...
	*/
	...
	{
	public:
		/** @brief Object types that can be labelled (values are irrelevant for the PVR backend) */
		...
		/**
			@brief RAII scope for a debug message group (a no-op for the PVR backend)
		*/
		class ScopedGroup
		{
		public:
