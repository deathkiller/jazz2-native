...
namespace nCine::RHI::Software
{
	...
	*/
	...
	{
	public:
		/** @brief Object types that can be labelled (values are irrelevant for the software backend) */
		...
		/**
			@brief RAII scope for a debug message group (a no-op for the software backend)
		*/
		class ScopedGroup
		{
		public:
