		...
		for (auto* player : players) {
			...
			if (playerType) {
				switch (*playerType) {
					...
					case PlayerType::Bird: PreloadMetadataAsync("Interactive/PlayerBird"_s); break;
					case PlayerType::BirdYellow: PreloadMetadataAsync("Interactive/PlayerBirdYellow"_s); break;
				}
			}
		}
