...
namespace Jazz2
{
	...
	*/
	...
	public:
		...
		/**
		 * @brief Called after a server-side force/knockback is applied to a player
		 *
		 * Allows the change to be synchronized to the owning client in a non-local session (no-op in
		 * local/single-player sessions).
		 */
